"""Lesson 08 exercise: grow a reproducible dungeon from connected cells."""
...
def make_dungeon(seed, size=7):
    ...
    cells = {(size // 2, size // 2)}
    # TODO: repeatedly choose an existing cell and one of its four neighbors.
    while len(cells) < 12:
...
def main():
    # TODO: try another seed after checking that the count remains twelve.
